...
//        Log.d("TAGINN1",view.toString())
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.imageName.text = currentItem?.name
        holder.imageContentUrl.text = currentItem?.contentUrl
...
//        val isImageDetailVisible = false
        ...
        val imageName: TextView = view.findViewById(R.id.imageNameTextView)
        val imageContentUrl: TextView = view.findViewById(R.id.imageContentUrlTextView)
